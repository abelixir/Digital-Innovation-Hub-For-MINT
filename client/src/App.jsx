...
import BuildersDirectory from "./pages/directory/BuildersDirectory";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/citizen/builders" element={<ProtectedRoute roles={["citizen"]}><BuildersDirectory embedded /></ProtectedRoute>} />
